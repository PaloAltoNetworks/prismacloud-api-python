...
```
pcs-toolbox # python3 scripts/pcs_configure.py --config_file ~/pc-settings.conf
```
...
Use the `pcs_configure` script to save a configuration file. Configuration options include:
...
```
python3 scripts/pcs_configure.py --username "Example Access Key" --password "Example Secret Key" --api "app.prismacloud.io"

python3 scripts/pcs_configure.py --username "Example Access Key" --password "Example Secret Key" --api "app.prismacloud.io" --config_file ~/example-pc-settings.conf

python3 scripts/pcs_configure.py --username "Example Username" --password "Example Password" --api_compute "onpremise.example.com"
```
...
```
python3 scripts/pcs_policy_set_status.py --policy_type config enable
```
...
```
python3 scripts/pcs_policy_status.py --policy_type all disable
...
```
python3 scripts/pcs_images_packages_read.py

python3 scripts/pcs_images_packages_read.py --image_id "sha256:c004737361182d3cd7f38e6d9ce4a44f2a349b8dc996834e2cba0defcd0cb522"
```
...
```
python3 scripts/pcs_images_packages_read.py --package_type jar --package_id log4j

python3 scripts/pcs_images_packages_read.py --package_type jar --package_id log4j:2.14.1 --version_comparison lt --output_to_csv True
```
...
```
python3 scripts/pcs_posture_endpoint_client.py GET v2/policy
```
...
```
python3 scripts/pcs_compute_endpoint_client.py GET api/v1/statuses/intelligence
```

...
for cloud_account_group_to_import in cloud_account_group_list_to_import:
    ...
    cloud_account_group_name_to_import = "ag_" + cloud_account_group_to_import['username'].lower() + "_" + cloud_account_group_to_import['type']
    if not cloud_account_group_duplicate:
        ...
        for cloud_account_group_current in cloud_account_group_list_current:
            if cloud_account_group_name_to_import.lower() == cloud_account_group_current['name'].lower():
    ...
    if not cloud_account_group_duplicate:
        ...
        cloud_account_group['name'] = cloud_account_group_name_to_import
        cloud_account_group['description'] = "This is the Account Group created for " + cloud_account_group_to_import['username'].lower() + " as " + cloud_account_group_to_import['type']
        accountId_string = cloud_account_group_to_import['id'][1:-1]

...
class RLSession(object):
    ...
    # Also retry for authentication failure (401) within try_wrapper().
    ...
    def build_header(self):
        # Construct the authentication header, required for all API requests.
        header = {"x-redlock-auth": self.auth_token, "Content-Type": "application/json"}
        return header
    ...
    def try_wrapper(self, verb, url, params, reqbody):
        ...
        # Raise ValueError if invalid action is specified.
